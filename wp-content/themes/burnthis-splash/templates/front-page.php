...
<?php get_header(); ?>
  ...
  <div class="push-footer">
    <div class="main-wrapper">
      <div class="header-wrapper"><img src="<?= get_template_directory_uri(); ?>/_images/burnthis_hero_image_desktop_v2.jpg" alt="" class="hero-desktop"><img src="<?= get_template_directory_uri(); ?>/_images/burnthis_hero_image_mobile.jpg" alt="" class="hero-mobile"></div>
